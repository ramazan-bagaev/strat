...
public class PrimingRoadCrossObject extends TransportNetNodeObject {
    ...
    public PrimingRoadCrossObject(Field parent, Index cellPos, Index size) {
    ...
    public void setShapes() {
        ...
        RectangleShape rectangleShape = new RectangleShape(new Coord(shift, shift),
                new Coord(cellSize*size.x - 2*shift, cellSize*size.y - 2*shift), new Color(Color.Type.Brown), false, true);
