...
public class Line {
    ...
    public boolean intersect(Line line){
        int deter = alpha * line.beta - beta * line.alpha;
        if (deter == 0){
            if (a.equals(line.a) || a.equals(line.b) || b.equals(line.a) || b.equals(line.b)) return true;
            return false;
        }
        float t = (float)(line.beta * (line.a.x - a.x) - beta * (line.a.y - a.y)) / (float)deter;
        float t1 = (float)(alpha * (line.a.x - a.x) - line.beta * (line.a.y - a.y))/ (float)deter;
        System.out.println(t + " " + t1);
        float x = a.x + (b.x - a.x) * t;
        float y = a.y + (b.y - a.x) * t;
    ...
    public static void main(String[] argv){
        Line line1 = new Line(new Coord(1, 1), new Coord(-1, -1));
        Line line2 = new Line(new Coord(-2, 0), new Coord(2, 0));
