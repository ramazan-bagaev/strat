...
public class RockResourceImage extends Image {
    ...
    public void setShapes(){
        RectangleShape rectangleShape = new RectangleShape(getPos(), new Coord(getSize().x / 3, 2 * getSize().y/3), BasicShape.Color.Gray, true);
        RectangleShape rectangleShape1 = new RectangleShape(getPos().add(new Coord(getSize().x/2, getSize().y/3)),
                new Coord(getSize().x/3, getSize().y/3), BasicShape.Color.LightGray);
        RectangleShape rectangleShape2 = new RectangleShape(getPos().add(new Coord(getSize().x/3, getSize().y/2)),
                new Coord(getSize().x/3,getSize().y/3), BasicShape.Color.Gray);
