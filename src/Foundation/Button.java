...
abstract public class Button extends WindowElement {
    ...
    public Button(Coord pos, Coord size, Window parent, String str){
        ...
        text = new StringShape(new Coord(pos.x + size.x/4, pos.y + size.y /4), new Coord(size.x/ 2, size.y /2), str, new Color(Color.Type.Black), font);
        carcas = new RectangleShape(pos, size, new Color(Color.Type.White), true);
